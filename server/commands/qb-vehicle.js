...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        if (args.give) {
            ...
            const save = await global.exports.oxmysql.insertSync("INSERT INTO player_vehicles (license, citizenid, vehicle, hash, mods, plate, state, garage) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", [
...
async function getVehicleByPlate(plate) {
    return await global.exports.oxmysql.executeSync("SELECT * FROM player_vehicles WHERE plate = ?", [plate]);
}
