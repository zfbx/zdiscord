...
*/
const locale = {
    checkingWhitelist: "Xin Chào {name}, Chúng Tôi Đang Kiểm Tra Whitelist Của Bạn..",
    discordNotOpen: "Bạn Cần Mở Discord Trước Khi Mở FiveM ( Khởi Động Lại Cả 2 Nếu Vẫn Bị )",
    fatalError: "Đã Xảy Ra Lỗi Khi Kiểm Tra Whitelist , Vui Lòng Liên Hệ Đội Ngũ Hỗ Trợ !.",
